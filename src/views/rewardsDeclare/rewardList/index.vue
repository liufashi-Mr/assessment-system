      ...
      >
        ...
        >
          <el-form-item label="奖项名称" prop="name">
            <el-input v-model="dataForm.name" placeholder="请输入奖项名称" />
          </el-form-item>
          <el-form-item label="奖项描述" prop="mark">
            <el-input v-model="dataForm.mark" placeholder="请输入奖项描述" />
          </el-form-item>
          <el-form-item label="奖项时间" prop="time">
            <el-input v-model="dataForm.time" placeholder="请输入奖项时间" />
          </el-form-item>
  ...
  data() {
    return {
      ...
      dataRule: {
        ...
        time: [{ required: true, message: '奖项时间不能为空', trigger: 'blur' }],
        college: [{ required: true, message: '面向学院不能为空', trigger: 'blur' }],
        condition: [
